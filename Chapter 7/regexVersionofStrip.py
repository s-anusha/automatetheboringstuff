...
'''
# Usage: python regexVersionOfStrip.py string - Removes whitespace from the beginning and end of the string
#	 python regexVersionOfStrip.py string substring_to_strip - Removes substring_to_strip from the beginning and end of the string
